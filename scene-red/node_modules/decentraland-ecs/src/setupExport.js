    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 18:
                    _e.sent();
                    return [4 /*yield*/, copyContentStatus({ exportDir: exportDir })];
                case 19:
                    _e.sent();
                    return [4 /*yield*/, (0, setupUtils_1.ensureWriteFile)(path.resolve(exportDir, 'content', 'available-content'), '[{"cid":"0","available":false}]')];
                case 20:
                    _e.sent();
                    return [3 /*break*/, 22];
                case 21:
...
var copyWearables = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var filesToDownload, wearableResponsePath, baseAvatarUrl, err_2, response, w_i, r_j, c_k, url, promises, _i, _b, fileUrl, url, filePath, err_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    filesToDownload = new Set();
                    wearableResponsePath = path.resolve(exportDir, 'lambdas', 'collections', 'wearables');
                    baseAvatarUrl = 'https://peer-lb.decentraland.org/lambdas/collections/wearables?collectionId=urn:decentraland:off-chain:base-avatars';
                ...
                case 11:
                    ...
                    console.error("Couldn't fetch base avatars to serve statically. Please verify your internet connection");
                    throw err_3;
                case 12: return [4 /*yield*/, (0, setupUtils_1.ensureWriteFile)(wearableResponsePath, JSON.stringify(response, null, 2))];
                case 13:
                    _c.sent();
                    return [2 /*return*/];
            }
