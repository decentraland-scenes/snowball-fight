...
var setupProxy = function (dcl, app) {
    ...
    try {
        (0, mock_catalyst_1.mockCatalyst)(app, baseSceneFolders, dcl.getWorkingDir());
    }
    catch (err) {
    ...
    try {
        (0, wearables_1.mockPreviewWearables)(app, baseWearableFolders, dcl.getWorkingDir());
    }
    catch (err) {
    ...
    (0, setupUtils_1.createStaticRoutes)(app, '/@/artifacts/unity-renderer/*', dclUnityRenderer, function (filePath) {
