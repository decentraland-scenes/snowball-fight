...
function findLibraryEntryPoint(packageName, cwd) {
    try {
...
function compile() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ts.sys.resolvePath = (path) => (0, path_1.resolve)(ts.sys.getCurrentDirectory(), path);
        {
            ...
            if (projectArgIndex != -1 && process.argv.length > projectArgIndex) {
                const folder = (0, path_1.resolve)(process.cwd(), process.argv[projectArgIndex + 1]);
        ...
        if (resolveFile('package.json')) {
            ...
            const bundledDependencies = [
                ...((packageJson === null || packageJson === void 0 ? void 0 : packageJson.bundleDependencies) || []),
                ...((packageJson === null || packageJson === void 0 ? void 0 : packageJson.bundledDependencies) || [])
            ];
        ...
        const diagnostics = yield emitFile(cfg.fileNames[0], services, cfg);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function loadJsLib(lib) {
            ...
            if (path) {
                ...
                loadedLibs.push({
                    path: (0, path_1.relative)(ts.sys.getCurrentDirectory(), path),
                    content,
        ...
        for (let [, file] of out) {
            if (file.path.endsWith('.js') && file.content && !file.path.endsWith('.min.js')) {
                loadedLibs.push({
                    path: (0, path_1.relative)(ts.sys.getCurrentDirectory(), fileName),
        ...
        for (let [, file] of out) {
            ensureDirectoriesExist((0, path_1.dirname)(file.path));
            if (file.content) {
...
function getConfiguration(packageJson, sceneJson) {
            ...
            if (packageJson.bundledDependencies instanceof Array) {
                packageJson.bundledDependencies.forEach(($, ix) => {
                    if (typeof $ == 'string') {
                        ...
                        console.error(`! Error: package.json .bundledDependencies must be an array of strings. The element number bundledDependencies[${ix}] is not a string.`);
                        hasError = true;
                    }
                });
            }
        ...
        if (resolved) {
            try {
                ...
                if (!libPackageJson.main) {
                    ...
                    main = (0, path_1.resolve)((0, path_1.dirname)(resolved), decentralandLibrary.main || libPackageJson.main);
                ...
                if (!libPackageJson.typings) {
                    ...
                    typings = (0, path_1.resolve)((0, path_1.dirname)(resolved), decentralandLibrary.typings || libPackageJson.typings);
                ...
                if (typeof e === 'object' && e) {
                    ...
                    console.error(`! Error in library ${libName}: ${e ? e.toString() : String.prototype.toString.apply(e)}`);
                }
                hasError = true;
            }
        }
    ...
    if (libs.length && isDecentralandLib) {
        console.log('! Error: this project of type decentralandLibrary includes bundledDependencies. bundledDependencies are only allowed in scenes.');
        process.exit(1);
    }
    if (hasError) {
        console.log('tsconfig.json:');
        console.log((0, util_1.inspect)(tsconfig, false, 10, true));
        process.exit(1);
    }
    ...
    if (hasCustomLibraries) {
        ...
        libs.forEach((lib) => {
            if (lib.name) {
                ...
                if (lib.typings) {
                    const relativePath = (0, path_1.relative)((0, path_1.dirname)(tsconfigPath), lib.typings);
...
function ensureDirectoriesExist(folder) {
    if (!ts.sys.directoryExists(folder)) {
        ...
        ensureDirectoriesExist((0, path_1.resolve)(folder, '..'));
