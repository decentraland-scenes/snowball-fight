...
var mockCatalyst = function (app, baseFolders, rootFolder) {
    ...
    app.get('/lambdas/profiles', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var previewWearables, deployedProfile, err_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!(previewWearables.length === 1)) return [3 /*break*/, 4];
                    return [4 /*yield*/, fetch("https://peer-lb.decentraland.org" + req.originalUrl)];
...
var serveFolders = function (app, baseFolders, catalystRootFolder) {
    ...
    app.get('/content/entities/scene', function (req, res, next) {
